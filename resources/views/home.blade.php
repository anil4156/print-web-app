...
<link rel="stylesheet" type="text/css" href="{{ url('node_modules/cropper/dist/cropper.css') }}"/>
<script src="{{ url('node_modules/cropper/dist/cropper.js') }}"></script>
<script src="https://fengyuanchen.github.io/cropper/js/main.js"></script>
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
<script src="{{ url('node_modules/cropper/dist/cropper.min.js') }}"></script>
<!-- <script src="{{ url('node_modules/cropper/dist/cropper.css') }}"></script> -->
			...
			<div class="row">
				...
				<div class="btn-group btn-group-crop">
				  <button type="button" class="btn btn-success" data-method="getCroppedCanvas" data-option="{ &quot;maxWidth&quot;: 4096, &quot;maxHeight&quot;: 4096 }">
				    <span class="docs-tooltip" data-toggle="tooltip" data-animation="false" title="" data-original-title="$().cropper(&quot;getCroppedCanvas&quot;, { maxWidth: 4096, maxHeight: 4096 })" aria-describedby="tooltip4856">
				      Get Cropped Canvas
				    </span>
				  </button>
				...
				<a class="btn btn-success btn-block" data-toggle="tooltip" data-animation="false" href="https://fengyuanchen.github.io/cropperjs" title="" data-original-title="The non-jQuery version of Cropper (recommended)">Cropper.js</a>
